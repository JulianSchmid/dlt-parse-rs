...
impl ExactSizeIterator for ArrayF64Iterator<'_> {
    #[inline]
    fn len(&self) -> usize {
        self.rest.len() / 8
    }
...
mod test {
    ...
    fn two_values_bytes_for(is_big_endian: bool, value0: f64, value1: f64) -> [u8; 16 + 7] {
